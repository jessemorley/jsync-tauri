...
const App = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-[#0f0f0f] text-white font-sans selection:bg-blue-500/30">
      ...
      <div className="w-[360px] rounded-2xl border border-white/10 shadow-2xl overflow-hidden relative bg-[#1c1c1e]/95 backdrop-blur-2xl shadow-black/50 transition-all duration-300">
